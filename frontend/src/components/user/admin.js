...
class Admin extends Component{
    ...
    render(){
        ...
        return(
            ...
            <button onClick={()=>{this.setState({disp1:'',disp2:'none'})}}> Job Type Details</button>
            <button onClick={()=>{this.setState({disp1:'none',disp2:''})}}> Statistics</button>

            <div className="jobtype" style={{display:this.state.disp1}}>
                    <h2>LIST OF JOB TYPES</h2>
