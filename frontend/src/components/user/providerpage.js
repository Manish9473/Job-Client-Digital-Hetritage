            ...
            <div className='Addjobs'>
                ...
                <table>
                    {this.state.jobs.map(x => <tr> 
                        <td>Title:{x.title}</td>
                        <td> Jobtype:{x.jobtype}</td>
                        
                        <td><button onClick={()=>this.handleRoute(x)}>Solutions</button> </td>
                        <td><button onClick={()=> this.handleRoutepages(x)}>Open Job</button></td>
                        <td> <button onClick={()=>{this.deletejob(x._id)}}>Delete</button></td>
                        </tr>)}
