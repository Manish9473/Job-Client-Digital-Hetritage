        ...
        return(
            <div className='Job'>
                ...
                <div className="Buttons" position="fixed" bottom="0" right="0">
                  ...
                  <button class="Buttons b5" onClick={()=>back()}>Undo</button>
                  <button class="Buttons b6" onClick={()=>this.ZoomIn()}>Zoom In</button>
                  <button class="Buttons b7" onClick={()=>this.ZoomOut()}>Zoom Out</button>
                  <button class="Buttons b6" onClick={()=>this.save()}>Save</button>
                ...
                <label>
                  Select the annotated Images
                    <input type="file" accept="image/x-png,image/gif,image/jpeg" onChange = {(event)=>{this.handleEvent(event)}} multiple/>
                </label>
                <label>
                    Details:
                    <textarea onChange={event=>{this.state.answer=event.target.value}}></textarea>
                </label>
                <label>
                  Final Submission
                  <button class="Buttons b3" onClick={event=>{this.handlesubmit()}}>Submit Job</button>
                </label>
